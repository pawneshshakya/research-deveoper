...
const Footer = () => {
    return (
        <div>
            <footer className="relative bg-slate-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-8 mt-20 ">
                    ...
                    <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                        <Link href="/">
                            <Image
                                src={logo}
                                alt="logo"
                                className="relative z-8 drop-shadow-lg pb-8 w-36"
                            />
                        </Link>
                        <p className="text-gray-400">
                            Unlock the hidden potential of your research. We will help you
                            refine your questions, analyze data like a pro, and craft a
                            masterpiece worthy of publication. Do not settle for average
                            papers. Our expert guidance elevates your research to the top
                            tier, leaving reviewers in awe.
                        </p>
                        ...
                        <ul className="mt-4">
                            ...
                            <li className="mt-4">
                                ...
                                >
                                    ...
                                    <span className="ml-3">+91 9788888292</span>
                                </Link>
                            </li>
                            <li className="mt-4">
                                <Link
                                    href="mailto:info@researchdevelopers.com"
                                    title="email"
                                    className="flex items-center opacity-75 hover:opacity-100"
                                >
                                    <span>
                                    ...
                                    <span className="ml-3">info@researchdevelopers.com</span>
                                </Link>
                            </li>
                        </ul>
                    </div>
